...
function FileField({ label, hint, accept, onChange, error, required, customIcon }) {
  ...
  return (
    <div className="form-group">
      ...
      <div
        ...
        tabIndex={0}
      >
        <div className="file-upload-icon" style={customIcon && !fileName ? { marginBottom: '8px' } : {}}>
          {fileName ? (
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
          ) : customIcon ? (
            <img src={customIcon} alt="Custom upload icon" style={{ height: '32px', width: 'auto' }} />
          ) : (
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} noValidate>
      ...
      <div className="form-card">
        ...
        <div className="form-group">
          <label htmlFor="booking_id">Booking ID No. <span className="req">*</span></label>
          <input
            id="booking_id"
            className={`form-control ${errors.booking_id ? 'is-invalid' : ''}`}
            type="text"
            placeholder="Enter your KonfHub booking ID"
            {...register('booking_id', { required: 'Booking ID is required' })}
          />
          {renderError('booking_id')}
        </div>

        <FileField
          label="Ticket generated by KonfHub"
      ...
      <div className="form-card">
        ...
        <div className="form-group" style={{ marginBottom: 0 }}>
          ...
          <div className="radio-group" style={{ marginTop: '12px' }}>
            {[
              { value: 'Yes', label: 'Yes, accommodation is required', desc: 'A simple or Dormitory accomodation will be provided' },
              { value: 'No', label: 'No, I will manage independently', desc: 'No accommodation arrangements will be made for you. (Nearby: Abhijeet Lodge, Sukhodaya (Utsav) Lodge, Sukha Sagar Lodging)' },
            ].map((opt) => (
              <label key={opt.value} className="radio-label">
                <input
                  type="radio"
